...
public class VisitHistory extends HttpServlet {
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response)//homework2
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)//homework3
			throws ServletException, IOException {
		try {
